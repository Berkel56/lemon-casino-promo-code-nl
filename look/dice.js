...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-26ccdc23');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-26ccdc23');}
...
var brandEl=document.querySelector('.rl-brand-26ccdc23');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
